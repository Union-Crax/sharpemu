...
//
// Usage: Hyper5.Tools.ShaderDump [output-directory]

using System.Buffers.Binary;
using System.Reflection;
using Hyper5.HLE;
using Hyper5.Libs.CxxAbi;
...
var shaderTranslator = assembly.GetType("Hyper5.Libs.Agc.Gen5ShaderTranslator")
    ?? throw new InvalidOperationException("Gen5ShaderTranslator not found");
var spirvTranslator = assembly.GetType("Hyper5.Libs.Agc.Gen5SpirvTranslator")
...
var stateType = assembly.GetType("Hyper5.Libs.Agc.Gen5ShaderState")
    ?? throw new InvalidOperationException("Gen5ShaderState not found");
var evaluationType = assembly.GetType("Hyper5.Libs.Agc.Gen5ShaderEvaluation")
    ?? throw new InvalidOperationException("Gen5ShaderEvaluation not found");
var imageBindingType = assembly.GetType("Hyper5.Libs.Agc.Gen5ImageBinding")
    ?? throw new InvalidOperationException("Gen5ImageBinding not found");
var globalBindingType = assembly.GetType("Hyper5.Libs.Agc.Gen5GlobalMemoryBinding")
    ?? throw new InvalidOperationException("Gen5GlobalMemoryBinding not found");
var pixelOutputBindingType = assembly.GetType("Hyper5.Libs.Agc.Gen5PixelOutputBinding")
    ?? throw new InvalidOperationException("Gen5PixelOutputBinding not found");
var pixelOutputKindType = assembly.GetType("Hyper5.Libs.Agc.Gen5PixelOutputKind")
