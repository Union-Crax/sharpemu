...
// Executes the Hyper5-emitted "exec" conformance shader on a real Vulkan
// device and compares the buffer results against CPU-computed expected values.
//
// The shader (exec-cs.spv, produced by Hyper5.Tools.ShaderDump) was
// translated by Hyper5 from hand-assembled Gen5 instruction words and stores
...
//
// Usage: Hyper5.Tools.GpuConformance <path-to-exec-cs.spv>
...
unsafe
{
    ...
    var appName = (byte*)SilkMarshal.StringToPtr("Hyper5GpuConformance");
    ...
    // Hyper5 emits all guest buffers as one descriptor array at set 0,
