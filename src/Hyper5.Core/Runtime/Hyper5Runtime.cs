...
using Hyper5.Libs.AppContent;
using Hyper5.Libs.SaveData;
...
public sealed class Hyper5Runtime : IHyper5Runtime
{
    private static readonly Hyper5Logger Log = Hyper5Log.For("Runtime");
    ...
    public static IHyper5Runtime CreateDefault(Hyper5RuntimeOptions options = default)
    {
    ...
    {
        const string app0VariableName = "HYPER5_APP0_DIR";
        ...
        ref int unresolved)
    {
        ...
        var logRebind = string.Equals(
            Environment.GetEnvironmentVariable("HYPER5_LOG_DATA_REBIND"),
            "1",
    ...
    {
        if (string.Equals(Environment.GetEnvironmentVariable("HYPER5_PRELOAD_ALL_SCE_MODULES"), "1", StringComparison.Ordinal))
        {
            return true;
        }
