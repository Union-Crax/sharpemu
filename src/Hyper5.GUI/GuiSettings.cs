...
public sealed class GuiSettings
{
    ...
    /// <summary>Show button prompts matching the currently connected controller.</summary>
    public bool ShowControllerButtonIcons { get; set; } = true;

    /// <summary>Last user-selected width of the game details dock.</summary>
    ...
    /// <summary>Names of HYPER5_* switches set to "1" in the emulator's environment at launch.</summary>
    public List<string> EnvironmentToggles { get; set; } = new();

    /// <summary>
    /// Discord application ID used for Rich Presence; the default is the
    /// Hyper5 application. Override to rebrand what Discord shows as
