...
namespace Hyper5.Libs.UserService;
...
public static class UserServiceExports
{
    ...
    private const string PrimaryUserName = "Hyper5";
    private static int _loginEventDelivered;

    private static readonly bool _traceUserService =
        string.Equals(Environment.GetEnvironmentVariable("HYPER5_LOG_USER_SERVICE"), "1", StringComparison.Ordinal);
