...
namespace Hyper5.Libs.SaveData;
...
public static class SaveDataExports
{
    ...
    {
        var configured = Environment.GetEnvironmentVariable("HYPER5_SAVEDATA_DIR");
    ...
    {
        if (string.Equals(Environment.GetEnvironmentVariable("HYPER5_LOG_SAVEDATA"), "1", StringComparison.Ordinal))
        {
