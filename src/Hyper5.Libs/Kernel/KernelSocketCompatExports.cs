...
internal static class KernelSocketCompatExports
{
        ...
        out OrbisGen2Result error)
    {
        ...
        if (string.Equals(Environment.GetEnvironmentVariable("HYPER5_LOG_NET"), "1", StringComparison.Ordinal))
        {
    ...
    {
        var redirect = Environment.GetEnvironmentVariable("HYPER5_NET_REDIRECT");
