...
public static class KernelRuntimeCompatExports
{
    ...
    private static readonly bool _traceGuestThreads =
        string.Equals(Environment.GetEnvironmentVariable("HYPER5_LOG_GUEST_THREADS"), "1", StringComparison.Ordinal);
    ...
    {
        if (!string.Equals(Environment.GetEnvironmentVariable("HYPER5_LOG_PROC_PARAM"), "1", StringComparison.Ordinal))
        {
            return;
        }
    ...
    {
        if (!string.Equals(Environment.GetEnvironmentVariable("HYPER5_LOG_PROC_PARAM_PTRS"), "1", StringComparison.Ordinal))
        {
            return;
        }
    ...
    public static int KernelGetGpi(CpuContext ctx)
    {
        ...
        if (string.Equals(Environment.GetEnvironmentVariable("HYPER5_LOG_ALLOC_IMPORTS"), "1", StringComparison.Ordinal))
        {
            Console.Error.WriteLine(
    ...
    private static ulong ResolveKernelTscFrequency()
    {
        ...
        var overrideHzText = Environment.GetEnvironmentVariable("HYPER5_TSC_FREQ_HZ");
    ...
    {
        return string.Equals(Environment.GetEnvironmentVariable("HYPER5_LOG_VIRTUAL_MEMORY"), "1", StringComparison.Ordinal);
    }
}
