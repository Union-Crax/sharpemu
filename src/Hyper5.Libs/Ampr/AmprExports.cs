...
public static class AmprExports
{
    ...
    private static readonly bool _traceAmpr =
        string.Equals(Environment.GetEnvironmentVariable("HYPER5_LOG_AMPR"), "1", StringComparison.Ordinal);
    private static readonly bool _traceAmprReads =
        _traceAmpr ||
        string.Equals(Environment.GetEnvironmentVariable("HYPER5_LOG_AMPR_READS"), "1", StringComparison.Ordinal);
