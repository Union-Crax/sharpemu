...
namespace Hyper5.HLE.Host.Posix;
...
/// the hardware on bare ALSA setups; HYPER5_ALSA_DEVICE overrides it.
/// </summary>
internal sealed unsafe class PosixAlsaAudioStream : IHostAudioStream
{
    ...
    public PosixAlsaAudioStream(uint sampleRate)
    {
        ...
        var device = Environment.GetEnvironmentVariable("HYPER5_ALSA_DEVICE");
