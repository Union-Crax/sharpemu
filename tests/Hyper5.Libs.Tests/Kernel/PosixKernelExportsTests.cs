...
namespace Hyper5.Libs.Tests.Kernel;
...
public sealed class PosixKernelExportsTests : IDisposable
{
    ...
    public PosixKernelExportsTests()
    {
        ...
        _tempRoot = Directory.CreateTempSubdirectory("hyper5-posix-tests-").FullName;
    }
    ...
    {
        var name = $"/hyper5-test-{Environment.ProcessId}-{Guid.NewGuid():N}";
